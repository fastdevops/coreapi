	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/fastdevops/coreapi/api/v1/example"`,
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/fastdevops/coreapi/router/example"`,
				StructName:        "Example",
				PackageName:       "example",
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/fastdevops/coreapi/service/example"`,
